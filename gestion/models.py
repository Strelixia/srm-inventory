...
class User(AbstractUser):
    ...
    role = models.CharField(max_length= 8, choices= [('admin', 'Admin'),('buyer', 'Buyer'),('supplier','Supplier')])
    groups = models.ManyToManyField('auth.Group', related_name='gestion_user_groups')
    user_permissions = models.ManyToManyField('auth.Permission', related_name='gestion_user_permissions')
    def __str__(self):
